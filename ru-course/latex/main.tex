...
\begin{itemize}
	\item Explain the domain of keyword spotting based on audio
	\item Explain the domain of image classification and already established models
	\item Explain the connection between both by introducing spectrograms and use the picture between spectrogram and wave representation
	\item Show the advantage of CNNs in the domain of image classification
	\item Use the introduction of image classification, CNNs, ImageNet and go over to the idea of transfer learning
\end{itemize}
