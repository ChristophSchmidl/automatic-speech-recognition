...
\end{tabular}
\caption{Final baseline results}
\label{tab:v1_v2_results}
\end{table}
...
\end{tabular}
\caption{Baseline results after one epoch}
\label{tab:v1_v2_results}
\end{table}
...
\end{tabular}
\caption{Final CNN results with Xavier initialization}
\label{tab:v1_v2_results}
\end{table}
...
\end{tabular}
\caption{CNN results after one epoch with Xavier initialization}
\label{tab:v1_v2_results}
\end{table}
...
\end{tabular}
\caption{Final CNN results with Imagenet weight initialization}
\label{tab:v1_v2_results}
\end{table}
...
\end{tabular}
\caption{CNN results after one epoch with Imagenet weight initialization}
\label{tab:v1_v2_results}
\end{table}
